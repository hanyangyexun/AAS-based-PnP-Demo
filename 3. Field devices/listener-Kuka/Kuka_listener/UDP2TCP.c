...
#define Epson_tcp_PORT 59152     //TCP port for Epson
#define Kuka_tcp_PORT 59152	////TCP port for Kuka
#define Epson_tcp_address "192.168.0.2" // Ip address of Epson

/****************End******************/

#define UDP_SERVER_PORT 6666	//udp server port of TSN taker
...
int udp_client_init()
{
    ...
    servaddr.sin_addr.s_addr = inet_addr("192.168.0.80");  // Ip address of TSN Talker 
