...
#define UADD "192.168.0.65"     //UDP SERVER ADDRESS : connecting with TSN Listener
#define UPORT 11181		//UDP SERVER PORT
...
const char* Pcommd06 = "\nL_D_P\n";
const char* Pcommd07 = "\nL_D_D\n";
//const char* Pcommd08 = "CENTER"; //Pcommd08 - SCARA ROBOT
...
{
 //printf("UC_Epson_C4_Start_Set attach\n");
}
...
if((UC_Turntable_Running_Status=(char*)shmat(shmid2,(void*)0,0))==(void*)-1){
 ...
 //printf("UC_Turntable_Running_Status attach\n");
}
...
{
 //printf("UC_EPSON_C4_Running_Status attach\n");
}
...
{
 //printf("UC_EPSON_C4_SensorLR_Running_Status attach\n");
}
...
int epson_C4_running_stat = 0;  // 1 is start, 0 is stop
...
int check_UC_Turntable_Running_Status = 3;
...
while(1)
{
 ...
 usleep(120*1000); //Stable periodic
...
{
 //printf("waiting the lamp control data..");
}
...
if(check_UC_Turntable_Running_Status == 0) epson_C4_running_stat = 1;
if(check_UC_Turntable_Running_Status == 2) epson_C4_running_stat = 1;
if(check_UC_Turntable_Running_Status == 1) epson_C4_running_stat = 0;
...
if(atoi((char *)UC_Turntable_Running_Status) == 0 && strcmp(UC_Epson_C4_Start_Set,"0") == 0 && atoi((char *)UC_EPSON_C4_Running_Status) == 0) epson_C4_running_stat=0;
...
if(atoi((char *)UC_Turntable_Running_Status) == 0 && (strcmp(UC_Epson_C4_Start_Set,"S1") == 0||strcmp(UC_Epson_C4_Start_Set,"S3") == 0))
{

 sprintf(UC_EPSON_C4_Running_Status,"1"); // ->>> UC_Turntable_Running_Status = 2
}
...
epson_C4_running_stat == 1 && 
sensor_RLflag == 1 && 
strcmp(UC_Epson_C4_Start_Set,"T1") != 0 && 
strcmp(UC_Epson_C4_Start_Set,"T2") != 0 && 
strcmp(UC_Epson_C4_Start_Set,"T3") != 0 && 
(strcmp(UC_Epson_C4_Start_Set,"S1") == 0 ||strcmp(UC_Epson_C4_Start_Set,"S3") == 0)||flag_RT1==1)
{
...
if(seq_RtoL == 15)
{
 ...
 epson_C4_running_stat = 0; //1 is robot start command or progressing program, 0 is defalt or waiting command
 ...
 sprintf(UC_EPSON_C4_Running_Status,"2"); // UC_Turntable_Running_Status = 1

} //if(seq_RtoL == 60)
else seq_RtoL++;
break;
}//switch(seq_RtoL)
}//if(epson_C4_running_stat == 1 && turntable_running_stat == 0 && sensor_RLflag == 1)
...
strcmp(UC_Epson_C4_Start_Set,"T2") != 0 && 
strcmp(UC_Epson_C4_Start_Set,"T3") != 0 &&
(strcmp(UC_Epson_C4_Start_Set,"S1") == 0||strcmp(UC_Epson_C4_Start_Set,"S3") == 0)||flag_RT2==1)
{
...
sprintf(UC_EPSON_C4_Running_Status,"2");
...
}//if(epson_C4_running_stat == 1 && turntable_running_stat == 0 && sensor_LRflag == 1)
...
if(epson_C4_running_stat == 1 && seq_RtoL==0 && seq_LtoR==0 && flag_RT1==0 && flag_RT2==0 && strcmp(UC_Epson_C4_Start_Set,"T1") != 0 && strcmp(UC_Epson_C4_Start_Set,"T2") != 0 && strcmp(UC_Epson_C4_Start_Set,"T3") != 0) stat_count++;

if(stat_count >= 3)
{
 //epson_C4_running_stat = 0;
 sensor_RLflag = 0;
 sensor_LRflag = 0;
 stat_count = 0;
}
 ...
 * const char* Lcommd06 = "\n3CGF\n";
 *******************************************************************************************/
if(strcmp(UC_Epson_C4_Start_Set,"S1") == 0 && lamp_flag != 1 && seq_LtoR == 0 && seq_RtoL == 0)
{
 lamp_flag = 1;
 sendto(sockfd, Lcommd05, strlen(Lcommd05), 0, (struct sockaddr *)&ser_addr, sizeof(ser_addr));
}
else if(strcmp(UC_Epson_C4_Start_Set,"S3") == 0 && lamp_flag != 3 && seq_LtoR == 0 && seq_RtoL == 0)
{
 lamp_flag = 3;
 sendto(sockfd, Lcommd05, strlen(Lcommd05), 0, (struct sockaddr *)&ser_addr, sizeof(ser_addr));
}
else if(strcmp(UC_Epson_C4_Start_Set,"S2") == 0 && lamp_flag != 2 && seq_LtoR == 0 && seq_RtoL == 0)
{
 lamp_flag = 2;
 sendto(sockfd, Lcommd01, strlen(Lcommd01), 0, (struct sockaddr *)&ser_addr, sizeof(ser_addr));
}
else if((strcmp(UC_Epson_C4_Start_Set,"T1") == 0 || strcmp(UC_Epson_C4_Start_Set,"T2") == 0|| strcmp(UC_Epson_C4_Start_Set,"T3") == 0)  && lamp_flag != 4 && seq_LtoR == 0 && seq_RtoL == 0)
{
 lamp_flag = 4;
 usleep(100*1000);
...
/*
else if(strcmp(UC_Epson_C4_Start_Set,"T3") == 0 && lamp_flag != 5 && seq_LtoR == 0 && seq_RtoL == 0)
{
 lamp_flag = 5;
 sendto(sockfd, Lcommd05, strlen(Lcommd05), 0, (struct sockaddr *)&ser_addr, sizeof(ser_addr));
 sprintf(UC_EPSON_C4_Running_Status,"0"); 
...
{current_lamp_cp=current_lamp;
 //printf("Current EPSON C4 robot lamp status : RED ON\n");
 sprintf(UC_EPSON_C4_Indicator_Light_Status,"%s",current_lamp); //send to opc ua server
}
else if(strcmp(current_lamp,"3CRF") == 0) 
{current_lamp_cp=current_lamp;
 //printf("Current EPSON C4 robot lamp status : RED OFF\n");
 sprintf(UC_EPSON_C4_Indicator_Light_Status,"%s",current_lamp); //send to opc ua server
}
else if(strcmp(current_lamp,"3CYO") == 0) 
{current_lamp_cp=current_lamp;
 //printf("Current EPSON C4 robot lamp status : YELLOW ON\n");
 sprintf(UC_EPSON_C4_Indicator_Light_Status,"%s",current_lamp); //send to opc ua server
}
else if(strcmp(current_lamp,"3CYF") == 0) 
{current_lamp_cp=current_lamp;
 //printf("Current EPSON C4 robot lamp status : YELLOW OFF\n");
 sprintf(UC_EPSON_C4_Indicator_Light_Status,"%s",current_lamp); //send to opc ua server
}
else if(strcmp(current_lamp,"3CGO") == 0) 
{current_lamp_cp=current_lamp;
 //printf("Current EPSON C4 robot lamp status : GREEN ON\n");
 sprintf(UC_EPSON_C4_Indicator_Light_Status,"%s",current_lamp); //send to opc ua server
}
else if(strcmp(current_lamp,"3CGF") == 0) 
{current_lamp_cp=current_lamp;
 //printf("Current EPSON C4 robot lamp status : GREEN OFF\n");
 sprintf(UC_EPSON_C4_Indicator_Light_Status,"%s",current_lamp);
}
else 
{
...
sprintf(UC_EPSON_C4_SensorLR_Running_Status,"%s",sensorLR_running_stat);//send to opc ua server
}
...
{
 //printf("Waiting two sensor data...\r\n");
}
...
/********************************************************************************************
 ...
 if epson_C4_running_stat is 1 , sensor_RLflag or sensor_LRflag will be set up

********************************************************************************************/
/*
if(epson_C4_running_stat == 1 && stat_count == 10 && left_sensor_flag == 0 && right_sensor_flag == 1 && seq_RtoL==0 && seq_LtoR==0) 
{
 sensor_RLflag = 1;  sensor_LRflag = 0;
}
*/
if(epson_C4_running_stat == 1 && stat_count == 2 && strcmp(sensorLR_running_stat,"SLR01")==0 && seq_RtoL==0 && seq_LtoR==0) 
{
 sensor_RLflag = 1;  sensor_LRflag = 0;
}
else if(epson_C4_running_stat == 1 && stat_count == 2 && strcmp(sensorLR_running_stat,"SLR10")==0 && seq_RtoL==0 && seq_LtoR==0)
{
...
printf("V:\t%s\n",ptrV);
printf("W:\t%s\n",ptrW);
sprintf(UC_EPSON_C4_X_Data,"%s",ptrX); //send the coordinates to opc ua server
sprintf(UC_EPSON_C4_Y_Data,"%s",ptrY); //send the coordinates to opc ua server
sprintf(UC_EPSON_C4_Z_Data,"%s",ptrZ); //send the coordinates to opc ua server
sprintf(UC_EPSON_C4_U_Data,"%s",ptrU); //send the coordinates to opc ua server
sprintf(UC_EPSON_C4_V_Data,"%s",ptrV); //send the coordinates to opc ua server
sprintf(UC_EPSON_C4_W_Data,"%s",ptrW); //send the coordinates to opc ua server
...
printf("             1. epson_C4_running_stat       : %d\r\n", epson_C4_running_stat);
...
printf("             8. UC_Epson_C4_Start_Set       : %s\r\n", UC_Epson_C4_Start_Set);
printf("             9. UC_Turntable_Running_Status : %s\r\n", UC_Turntable_Running_Status);
printf("            10. UC_EPSON_C4_Running_Status  : %s\r\n", UC_EPSON_C4_Running_Status);
printf("----------------------------------------------------------------------\r\n");
