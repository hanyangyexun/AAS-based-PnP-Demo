...
void set_serverUrl(UA_ServerConfig *serverConfig) {
	...
	serverConfig->applicationDescription.applicationUri = UA_STRING("http://www.iosb.fraunhofer.de/finalpnpserver.aml");
	serverConfig->applicationDescription.applicationName = UA_LOCALIZEDTEXT("en", "AML2UA - Fraunhofer IOSB providing finalpnpserver.aml");
